...
if(isset($_POST['add_product'])){
   ...
   if(mysqli_num_rows($select_product_name) > 0){
      ...
      $add_product_query = mysqli_query($conn, "INSERT INTO `products`(name, price, image, category_id, featured,quantity) VALUES('$name', '$price', '$image', '$c','$f','$q')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   mysqli_query($conn, "UPDATE `products` SET name = '$update_name', price = '$update_price', category_id='$update_cat_id',featured='$f',quantity='$update_quantity' WHERE id = '$update_p_id'") or die('query failed');
